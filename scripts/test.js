...
var dataBase = new Map();
    ...
    for(let recipe of recipes){
        ...
        temporaryDataBase.push(recipe.name.toLowerCase());
        temporaryDataBase.push(recipe.description.toLowerCase());
        recipe.ingredients.forEach(ingredient =>{
            temporaryDataBase.push(ingredient.ingredient.toLowerCase())
        });
